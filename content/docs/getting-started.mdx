...
|------|-----------------|
| [Server Setup](/docs/server-setup) | Create a local dev server for testing |
| [Your First Plugin](/docs/your-first-plugin) | Build a complete plugin with commands, menus, and storage |
